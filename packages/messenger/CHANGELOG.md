...
- [#19](https://github.com/Goya-24/goya24-js/pull/19) [`c2d5c08`](https://github.com/Goya-24/goya24-js/commit/c2d5c08e912f17b935d2cb114d052492577c4ec8) Thanks [@aryasadeghy](https://github.com/aryasadeghy)! - `user.phone` reaches goya24. It was not part of `User`, and both the `data-user` tag and the `identify()` claim dropped it, so a number a site passed never arrived; it now travels with the name and email.
